...
*/
   ...
   public:
      ...
      void DrawFill(HDC DC, HBRUSH hFillBrush);
      void DrawBorder(HDC DC);

#ifdef __DDGRAPH
      void TransLL(DDGraph* pTrans, const LatLong& ScreenMin, const LatLong& ScreenMax);
#else
...
#ifdef __DDGRAPH
   void RegenPixels(DDGraph* pTrans, const LatLong& MinLL, const LatLong& MaxLL);
#else
   void RegenPixels(TransGraph* pTrans, const LatLong& MinLL, const LatLong& MaxLL);
#endif

   void Draw(HDC DC, const TColor Col, const bool bFill=true);
