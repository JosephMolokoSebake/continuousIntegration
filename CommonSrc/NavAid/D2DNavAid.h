...
public:
   ...
   void Draw(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer, const TColor BackColor);
   void DrawRect(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer);
   ...
   void CalcSize(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer, const bool bStandAlone=false);
   String sSymbolType();
...
public:
   ...
   ~ManVectStruct();
	...
	void Read(JIniFile* pFil, const int n);
	void SetPos(const Pixel& p1, const Pixel& p2);
	void Draw(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer, const int nID);
...
public:
   ...
   ~NavAidClass();
	...
	void DrawAll(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer, const TColor BackColor);
   ...
   void TransformPos(TransGraph* pG, const bool bCalcSize=false);
...
//Lines *******************************************************
   ...
   void DrawLines(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer, const TColor BackColor);
...
// Symbols *******************************************************
   ...
   TRect GetCurrentSymbolRect(const int nx, const int ny);
   ...
   void DrawSymbolRect(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer, const Pixel& Pix, const LatLong& LL);
...
//   void SetSymbolRef(const bool bSetRef);
   ...
   void CalcSymbolSize(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer);
	void CalcSymbolBounds();

   void DrawSymbols(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer, const TColor BackColor);
...
// Arcs *********************************************************
   ...
   void DrawArcs(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer, const TColor BackColor);
...
//Manual Vectors ************************************************
   ...
   void DrawVectors(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer);
...
// Reference Symbol
   ...
   void DrawRef(D2DDraw* pDraw, const DWG_LAYER_TYPE Layer, const TColor BackColor);
