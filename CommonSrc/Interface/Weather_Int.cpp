...
#include "Weather_Int.h"
//---------------------------------------------------------------------------
#pragma package(smart_init)

Weather_Int::Weather_Int(const int nUSB_Serial, const int nMoveAveLength_sec) : USBSerial(USB_DETECT_DEV,nUSB_Serial)
{
...
bool Weather_Int::bUpdate_Simulated(char* aucRXBufSim,int nRXBufSim)
{
	bool bRX=false;
	int nRX=nRXBufSim;
	if (nRX>0)
...
void Weather_Int::GetMsg(JTime& T_utc, Cst4_Weather_Data& Data)
{
